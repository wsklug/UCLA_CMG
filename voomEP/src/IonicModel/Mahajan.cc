...
void Mahajan::ucla_rhsfun(double h, double istim) {
...
double Mahajan::comp_ina(double dt){
...
double Mahajan::comp_ikr(double dt)
{
...
double Mahajan::comp_iks(double dt) {
...
double Mahajan::comp_ito(double dt) {
    double ek = 1.0/_Constants[24]*log(_Constants[2]/_Constants[1]);// K reversal potential
...
//	routine.
double Mahajan::comp_icalpo(double dt) {
...
//the myoplasm.
double Mahajan::comp_inst_buffer(double c) {
...
double Mahajan::comp_dir(double po, double Qr, double rxa, double dcj) {
...
double Mahajan::comp_dcp(double po, double Qr, double rxa) {
